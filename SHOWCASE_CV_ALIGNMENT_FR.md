...
- Conception d'assistants IA utiles pour le support, l'acces a l'information et l'usage interne.

**Pourquoi c'est coherent avec le CV**
- Assistants IA et copilotes metier.
...
**Pourquoi c'est coherent avec le CV**
- Classification, prediction, detection de fraude.
...
- Orientation pilotage et aide a la decision.

**Pourquoi c'est coherent avec le CV**
- Dashboards, reporting, KPI, support a la decision.
